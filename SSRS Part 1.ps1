...
# Configuration data 
[string] $server   = "LGHBDVDB06";        # SQL Server Instance. 
[string] $database = "ReportServer";        # ReportServer Database. 
[string] $folder   = "\\aukbmedc01\Group\Shared\IT Strategy\BIDelivery\SSRS\";          # Path to export the reports to. 
