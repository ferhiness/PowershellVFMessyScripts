...
$RevisionToGet = 22904      #22490#22489#22488#22487  #21927  
$JIRANumber = "INFO-25751"
...
## Test
Invoke-DbaQuery -SqlInstance lghbdvdb06 -Database LinkReports -Query "SELECT ReportSubscriptionSkey,ReturnedValue, Result FROM  LinkReports.dbo.ReportSubscriptionsTestLog"
